...
public class DefaultExceptionHandler {
    ...
    public ResponseEntity<ApiError> handleException(RoomNotFoundException e, HttpServletRequest request) {
        ApiError apiError = new ApiError(
                request.getRequestURI(),
                e.getMessage(),
                HttpStatus.NOT_FOUND.value(),
    ...
    public ResponseEntity<ApiError> handleException(StudentNotFoundException e, HttpServletRequest request) {
        ApiError apiError = new ApiError(
                request.getRequestURI(),
                e.getMessage(),
                HttpStatus.NOT_FOUND.value(),
    ...
    public ResponseEntity<ApiError> handleException(InvalidParametersException e, HttpServletRequest request) {
        ApiError apiError = new ApiError(
                request.getRequestURI(),
                e.getMessage(),
